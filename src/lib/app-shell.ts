    ...
    <div id="aboutDialog" class="about-dialog" hidden>
      <section class="about-dialog__panel" role="dialog" aria-modal="true" aria-labelledby="aboutTitle" aria-describedby="aboutDescription">
        ...
        <section id="nativeIosPanel" class="native-ios-panel" aria-labelledby="nativeIosHeading" hidden>
          <div class="native-ios-panel__header"><div><p id="nativePlatformEyebrow">NATIVE APP</p><h3 id="nativeIosHeading">ڕێکخستنەکانی ئەپی NAV KURD</h3></div><span id="nativePlatformIcon" aria-hidden="true"><img class="native-ios-panel__icon" src="${appUrl("assets/native/info.svg")}" alt="" draggable="false"></span></div>
          ...
          <div class="native-ios-panel__actions"><button id="nativeClearCacheButton" type="button" aria-label="پاککردنەوەی cache ـی کاتی" title="پاککردنەوەی cache ـی کاتی"><img class="native-ios-panel__icon" src="${appUrl("assets/native/clear.svg")}" alt="" aria-hidden="true" draggable="false"><span id="nativeClearCacheLabel" class="native-ios-panel__action-label">پاککردنەوەی cache ـی کاتی</span></button><button id="nativeOpenSettingsButton" type="button" aria-label="کردنەوەی Settings" title="کردنەوەی Settings"><img class="native-ios-panel__icon" src="${appUrl("assets/native/settings.svg")}" alt="" aria-hidden="true" draggable="false"><span id="nativeOpenSettingsLabel" class="native-ios-panel__action-label">کردنەوەی Settings</span></button></div>
