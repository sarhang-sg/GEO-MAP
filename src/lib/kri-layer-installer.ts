...
export function installKriDynamicLayers(options: KriDynamicLayerOptions): void {
  ...
  map.addLayer({ id: "kri-locality-town", type: "circle", source: "kri-locality-major-source", minzoom: 7.8, filter: ["==", ["get", "place"], "town"], layout: { visibility: placesVisible ? "visible" : "none" }, paint: { "circle-radius": ["interpolate", ["linear"], ["zoom"], 8, 3, 13, 5.5], "circle-color": "#ffe09a", "circle-stroke-color": "#222647", "circle-stroke-width": 1.2 } });
  map.addLayer({ id: "kri-locality-city", type: "circle", source: "kri-locality-major-source", minzoom: 6.2, filter: ["==", ["get", "place"], "city"], layout: { visibility: placesVisible ? "visible" : "none" }, paint: { "circle-radius": ["interpolate", ["linear"], ["zoom"], 6.5, 5.1, 13, 8], "circle-color": "#ffc86e", "circle-stroke-color": "#242745", "circle-stroke-width": 1.35 } });
