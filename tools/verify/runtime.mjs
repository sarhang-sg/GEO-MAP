...
assert(routing.includes('recordNavigationHistory("arrived")') && routing.includes('recordNavigationHistory("cancelled")') && routing.includes("queueNavigationHistory(entry)") && routing.includes("saveAtlasNavigationHistory(entry)"), "Arrival and cancellation are not passed to the durable navigation-history writer.");
