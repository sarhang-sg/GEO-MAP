...
assert(shell.includes('class="map-loading__word"') && shell.includes('class="map-loading__slice"') && shell.includes('class="map-loading__line"') && shell.includes('class="map-loading__equation"') && shell.includes('2 + 2 = 1'), "Nine-slice Loading composition is incomplete.");
...
assert(loader.includes('.map-loading__slice:nth-child(9)') && loader.includes('.map-loading__equation') && loader.includes('nav-kurd-loading-wobble') && loader.includes('rgba(72, 0, 76, .86)') && loader.includes('rgba(3, 17, 43, .88)'), "New Loading component states are incomplete.");
