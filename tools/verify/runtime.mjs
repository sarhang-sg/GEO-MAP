...
assert(shell.includes('class="map-loading__word"') && shell.includes('class="map-loading__slice"') && shell.includes('class="map-loading__line"') && shell.includes('class="map-loading__equation"') && shell.includes('dir="ltr"') && shell.includes('1 + 1 = 2'), "Nine-slice Loading composition is incomplete.");
