...
const UI_REVISION = "R16-hotfix-4";
...
const SHELL_CACHE = `${CACHE_PREFIX}shell-s${CACHE_SCHEMA}-${RELEASE_ID}-${UI_REVISION}`;
const RUNTIME_CACHE = `${CACHE_PREFIX}runtime-s${CACHE_SCHEMA}-${RELEASE_ID}-${UI_REVISION}`;
